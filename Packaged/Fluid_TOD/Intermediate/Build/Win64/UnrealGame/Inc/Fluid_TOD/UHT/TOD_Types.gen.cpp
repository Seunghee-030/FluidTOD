...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FTODMasterData_Statics::NewProp_Moon_Settings = { "Moon_Settings", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FTODMasterData, Moon_Settings), Z_Construct_UScriptStruct_FTODMoonSettings, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Moon_Settings_MetaData), NewProp_Moon_Settings_MetaData) }; // 3915660540
...
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UTODPresetData_Statics::NewProp_TOD_DataArray = { "TOD_DataArray", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UTODPresetData, TOD_DataArray), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_TOD_DataArray_MetaData), NewProp_TOD_DataArray_MetaData) }; // 3337876751
...
struct Z_CompiledInDeferFile_FID_Users_laeum_Documents_GitHub_FluidTOD_Packaged_Fluid_TOD_HostProject_Plugins_Fluid_TOD_Source_Fluid_TOD_Public_TOD_Types_h__Script_Fluid_TOD_Statics
{
	...
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		...
		{ FTODMoonSettings::StaticStruct, Z_Construct_UScriptStruct_FTODMoonSettings_Statics::NewStructOps, TEXT("TODMoonSettings"),&Z_Registration_Info_UScriptStruct_FTODMoonSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FTODMoonSettings), 3915660540U) },
		...
		{ FTODMasterData::StaticStruct, Z_Construct_UScriptStruct_FTODMasterData_Statics::NewStructOps, TEXT("TODMasterData"),&Z_Registration_Info_UScriptStruct_FTODMasterData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FTODMasterData), 3337876751U) },
